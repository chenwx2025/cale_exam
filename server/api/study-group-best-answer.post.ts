...
export default defineEventHandler(async (event) => {
  ...
  try {
    console.log('[FLAT Best Answer] 设置最佳答案, postId:', postId, 'replyId:', replyId, 'userId:', user.userId)
    ...
    if (reply.isBestAnswer) {
      console.log('[FLAT Best Answer] 取消最佳答案')
      ...
      console.log('[FLAT Best Answer] 取消成功')
      return {
        success: true,
        action: 'unset',
        message: '已取消最佳答案',
      ...
      console.log('[FLAT Best Answer] 设置最佳答案')
      ...
      console.log('[FLAT Best Answer] 设置成功')
      return {
        success: true,
        action: 'set',
        message: '已设为最佳答案',
    ...
    console.error('[FLAT Best Answer] 设置失败:', error)
    throw createError({
      statusCode: 500,
      message: '设置最佳答案失败'
    })
